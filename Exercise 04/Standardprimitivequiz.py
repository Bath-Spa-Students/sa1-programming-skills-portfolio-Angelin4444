...
if Answer.strip().lower() == "vienna": #(writing the answer for the question without mattering if its in lower or upper case)
    print("The answer is correct") #(if the answer is correct then show this)
else:
     print("The answer is wrong") #(if the answer is wrong then show this)

#Writing the 2nd question to the variable ( with modification on upper and lower case)
